...
// should enable one and only one GPU target
      ...
      defined(CK_AMD_GPU_GFX908) || defined(CK_AMD_GPU_GFX90A) || defined(CK_AMD_GPU_GFX940) ||    \
      defined(CK_AMD_GPU_GFX941) || defined(CK_AMD_GPU_GFX942) || defined(CK_AMD_GPU_GFX1030) ||   \
      defined(CK_AMD_GPU_GFX1031) || defined(CK_AMD_GPU_GFX1036) || defined(CK_AMD_GPU_GFX1100) || \
      defined(CK_AMD_GPU_GFX1101) || defined(CK_AMD_GPU_GFX1102) || defined(CK_AMD_GPU_GFX1150) || \
      defined(CK_AMD_GPU_GFX1151) || defined(CK_AMD_GPU_GFX1200) || defined(CK_AMD_GPU_GFX1201))
...
#define CK_USE_AMD_V_MAC_F32
    ...
    defined(CK_AMD_GPU_GFX1030) || defined(CK_AMD_GPU_GFX1031) || defined(CK_AMD_GPU_GFX1036) || \
    defined(CK_AMD_GPU_GFX1100) || defined(CK_AMD_GPU_GFX1101) || defined(CK_AMD_GPU_GFX1102) || \
